...
function clearAllSanagerVms {
    ...
    deleteVm $MACHINE_NAME_RUNNER
    deleteVm $MACHINE_NAME_RUNNER_UNSTABLE
    deleteVm $MACHINE_NAME_GRAPHICAL_DESKTOP
    deleteVm $MACHINE_NAME_PC
    deleteVm $MACHINE_NAME_HOME_SERVER
    deleteVm $MACHINE_NAME_CRYPTO_VISUAL
    deleteVm $MACHINE_NAME_TEST_BASE_PREFIX
